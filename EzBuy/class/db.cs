...
namespace EzBuy
{
    ...
    class db
    {        
        public static String Wrap(Object value, DbType type)
        {
            switch (type)
            {
                case DbType.Boolean:
                ...
                case DbType.String:
                    return db.nseb(value.ToString());
                case DbType.Number:
                    return value.ToString();
                case DbType.Date:
                    return db.seb(value.ToString());
                default:
                    return value.ToString();
            }
        }
        public static string sqlconnection ="";
        public static string seb(string x)
        {
            //string embrace
            return "'" + x + "'";
        }
        public static string nseb(string x)
        {
            //string embrace
            return "N'" + x + "'";
        }
        ...
        public DataTable power(string done)
        {
            String tmp = done;
            return execute(tmp);
        }
